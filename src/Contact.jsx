...
const FAQS = [
  {
    ...
    answers: [
      "Para empresas construídas sobre conhecimento: consultorias, estúdios, escritórios e especialistas. Se o seu trabalho é forte, mas o site ainda não demonstra isso, a ideia é aproximar a sua presença digital do nível real do seu negócio.",
    ],
  },
  {
    question: "Para quem este trabalho não é indicado?",
    answers: [
      "Para quem procura uma aparência premium com um orçamento incompatível ou espera crescimento instantâneo. O foco aqui é construir uma presença digital consistente para negócios reais, sem promessas milagrosas.",
    ],
  },
  {
    question: "Por que trabalhar com uma pessoa em vez de uma agência?",
    answers: [
      "Porque nada se perde no caminho. Você fala diretamente comigo da estratégia ao lançamento, sem intermediários, repasses ou decisões desconectadas do seu negócio.",
    ],
  },
  {
    question: "Por que você não oferece pacotes fechados?",
    answers: [
      "Porque cada negócio pede uma solução diferente. Alguns projetos precisam de poucas páginas; outros exigem mais conteúdo, estratégia ou funcionalidades. O escopo se adapta ao problema, e não o contrário.",
    ],
  },
  {
    question: "Quanto tempo leva para criar um site?",
    answers: [
      "Em geral, um projeto leva de quatro a oito semanas, dependendo do tamanho e da velocidade dos retornos. O cronograma é definido antes de começar e permanece claro durante todo o processo.",
    ],
  },
  {
    question: "Por que você não garante mais vendas?",
    answers: [
      "Eu garanto um site capaz de representar sua experiência, transmitir confiança e dar às pessoas certas bons motivos para escolher você. Mais vendas e crescimento imediato dependem de outras partes do negócio e não podem ser prometidos com honestidade por um designer.",
      "Sites não criam grandes negócios. Eles ajudam grandes negócios a parecer grandes negócios.",
    ],
  },
  {
    question: "Como começamos?",
    answers: [
      "Você envia a ideia do projeto e fazemos uma conversa rápida para entender se existe encaixe. A partir disso, preparo uma proposta com escopo, prazo e investimento.",
    ],
  },
];
                  ...
                  <h3 className="faq__question-heading">
                    ...
                    >
                      <span className="faq__question">
                        <span className="faq__number">(Q{number})</span>
