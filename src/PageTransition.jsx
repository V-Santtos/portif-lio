...
export function PageTransitionProvider({ children }) {
  ...
  const transitionTo = useCallback((path) => {
    ...
    // reset logo ao estado invisível
    ...
    // painel sobe de baixo cobrindo a tela
    tl.to(overlay, {
      y: "0%",
      duration: 0.55,
      ease: "power3.inOut",
    ...
    // navega enquanto coberto
    tl.call(() => navigate(path));

    // painel sai pelo topo revelando nova página
    tl.to(overlay, {
      y: "-100%",
      duration: 0.55,
      ease: "power3.inOut",
    ...
    // reseta posição para próximo uso
